...
classdec  : CLASS ID ( IMPLEMENTS ID )? (LPAR vardec ( COMMA vardec)* RPAR)? CLPAR(classconstr SEMIC ( (fun SEMIC)+)? |
            ( (fun SEMIC)+ )? classconstr SEMIC)CRPAR;
classconstr : ID (LPAR vardec? ( COMMA vardec)* RPAR) (let)? exp?  ;
