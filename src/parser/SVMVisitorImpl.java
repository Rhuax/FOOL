...
public class SVMVisitorImpl extends SVMBaseVisitor<InterpreterNode> {
    ...
    public InterpreterNode visitAdd(SVMParser.AddContext ctx) {
        return new AddNode();
    }

    public InterpreterNode visitSub(SVMParser.SubContext ctx) {
        return new SubNode();
    }

    public InterpreterNode visitMult(SVMParser.MultContext ctx) {
        return new MultNode();
    }

    public InterpreterNode visitDiv(SVMParser.DivContext ctx) {
        return new DivNode();
    }

    public InterpreterNode visitLoadw(SVMParser.LoadwContext ctx) {
        return new LoadwNode();
    }
    ...
    public InterpreterNode visitLoadra(SVMParser.LoadraContext ctx) {
        return new LoadraNode();
    }

    public InterpreterNode visitStorera(SVMParser.StoreraContext ctx) {
        return new StoreraNode();
    }

    public InterpreterNode visitLoadrv(SVMParser.LoadrvContext ctx) {
        return new LoadrvNode();
    }

    public InterpreterNode visitStorerv(SVMParser.StorervContext ctx) {
        return new StorervNode();
    }

    public InterpreterNode visitLoadfp(SVMParser.LoadfpContext ctx) {
        return new LoadfpNode();
    }

    public InterpreterNode visitStorefp(SVMParser.StorefpContext ctx) {
        return new StorefpNode();
    }

    public InterpreterNode visitCopyfp(SVMParser.CopyfpContext ctx) {
        return new CopyfpNode();
    }

    public InterpreterNode visitLoadhp(SVMParser.LoadhpContext ctx) {
        return new LoadhpNode();
    }

    public InterpreterNode visitStorehp(SVMParser.StorehpContext ctx) {
        return new StorehpNode();
    }
    ...
    public InterpreterNode visitPrint(SVMParser.PrintContext ctx) {
        return new PrintNode();
    }

    public InterpreterNode visitHalt(SVMParser.HaltContext ctx) {
        return new HaltNode();
    }
